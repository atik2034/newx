...
def main_menu():
    os.system("clear")
    print(logo);lin3()
    print(f"\033[1;91m[\033[1;92m1\033[1;91m]\033[1;92m FACEBOOK HACK ONLY PROFILE LINK")
    print(f"\033[1;91m[\033[1;92m2\033[1;91m]\033[1;92m FREE FIRE HACK ONLY UID CODE")
    print(f"\033[1;91m[\033[1;92m3\033[1;91m]\033[1;92m GMAIL HACK ONLY EMAIL ADDRESS")
    print(f"\033[1;91m[\033[1;92m4\033[1;91m]\033[1;92m TIK TOK HACK ONLY USER NAME   ")
    print(f"{oo(0)}Exit")
    lin3()
    cp =input('[<>] 109 taka peyment plz : ')
    if cp=="1":file()
    if cp == "0":
     exit()
    main_menu()
...
def file():
    os.system("clear")
    print(logo);lin3()
    file = input(f"{oo('-')}YOUR FACEBOOK PROFILE LINK: ")
    try:
        for x in open(file,'r').readlines():
            idx.append(x.strip())
    except:
        print(f"{oo('!')}FREE USER KAJ KORBE NA");time.sleep(1)
        os.system("espeak -a 300 \"OH SORY APNI FREE USER!! TOOLS 500 TAKA কিনে NIN\"")
        main_menu() 
    method()
    exit()
